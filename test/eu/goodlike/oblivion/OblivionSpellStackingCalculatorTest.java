...
class OblivionSpellStackingCalculatorTest implements Supplier<String>, Consumer<String> {
  ...
  void jackOfAllTrades() {
    ...
    assertOutputSegment(
      ...
      "       Applied MAGIC DMG 10.0 for 1s",
      "01.060 You begin to swap your weapon.",
      "01.400 Expired <MELEE$dagger> MAGIC DMG",
      "02.121 You equip <BOW$bow>",
      "       You aim <ARROW> + <BOW$bow>",
      "03.702 You hit with <ARROW> + <BOW$bow>",
      "       Applied MAGIC DMG 10.0 for 1s",
      "04.282 You begin to swap your weapon.",
      "04.702 Expired <BOW$bow> MAGIC DMG",
      ...
      "08.072 You cast <SPELL$spell>",
      "08.342 Expired <MELEE$dagger> MAGIC DMG",
      "08.482 You hit with <SPELL$spell>",
      "       Applied MAGIC DMG 10.0 for 1s",
      "09.142 You begin to swap your weapon.",
      "09.482 Expired <SPELL$spell> MAGIC DMG",
      "10.203 You equip <BOW$bow>",
      "       You aim <ARROW> + <BOW$bow>",
      "11.784 You hit with <ARROW> + <BOW$bow>",
      "       Applied MAGIC DMG 10.0 for 1s",
      "12.514 You cast <SPELL$spell>",
      "12.784 Expired <BOW$bow> MAGIC DMG",
      "12.924 You hit with <SPELL$spell>",
      "       Applied MAGIC DMG 10.0 for 1s",
      "13.554 You begin to swap your weapon.",
      "13.924 Expired <SPELL$spell> MAGIC DMG",
      "14.725 You equip <STAFF$staff>",
      "       You invoke <STAFF$staff>",
      "15.255 You hit with <STAFF$staff>",
      "       Applied MAGIC DMG 10.0 for 1s",
      "15.885 You invoke <STAFF$staff>",
      "16.255 Expired <STAFF$staff> MAGIC DMG",
      "16.415 You hit with <STAFF$staff>",
      "       Applied MAGIC DMG 10.0 for 1s",
      "16.995 You begin to swap your weapon.",
      "17.415 Expired <STAFF$staff> MAGIC DMG",
      ...
      "19.005 You begin to swap your weapon.",
      "19.375 Expired <MELEE$dagger> MAGIC DMG",
      "20.176 You equip <STAFF$staff>",
      "       You invoke <STAFF$staff>",
      "20.706 You hit with <STAFF$staff>",
      "       Applied MAGIC DMG 10.0 for 1s",
      "       You stop beating the dead enemy",
      "21.706 Expired <STAFF$staff> MAGIC DMG",
