...
class OblivionSpellStackingCalculatorTest implements Supplier<String>, Consumer<String> {
  ...
  void andNowForSomethingCompletelyDifferent() {
    ...
    assertOutputSegment(
      ...
      "00.000 Effect: MAGIC  x2.00, SHOCK  x2.00, POISON x1.00",
      ...
      "00.000 Effect: MAGIC  x4.00, SHOCK  x4.00, POISON x3.00",
      ...
      "00.000 Effect: MAGIC  x7.00, SHOCK  x6.00, POISON x5.00",
      ...
      "01.000 Effect: MAGIC  x12.00, SHOCK  x9.00",
